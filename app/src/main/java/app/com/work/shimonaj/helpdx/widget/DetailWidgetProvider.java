        ...
        for (int appWidgetId : appWidgetIds) {
         ...
         //   Intent intent = new Intent(context, MainActivity.class);
           // PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, intent, 0);
            ...
            views.setImageViewResource(R.id.widget_icon, R.drawable.ic_dashboard_black_24dp);
...
//            views.setPendingIntentTemplate(R.id.widget_list, clickPendingIntentTemplate);
            views.setEmptyView(R.id.widget_list, R.id.listview_tickets_empty);
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (TicketSyncAdapter.ACTION_DATA_UPDATED.equals(intent.getAction())) {
